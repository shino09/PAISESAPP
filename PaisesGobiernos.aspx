<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PaisesGobiernos.aspx.vb" Inherits="PaisesGobiernos" MasterPageFile="~/Site.master" Title="Paises-Gobiernos" %>
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <h2>PAISES_GOBIERNOS</h2>
    <div class="toolbar">
    ...
    <div id="pnlAdd" runat="server" visible="false" class="modal-overlay show">
        <div class="modal-dialog">
            <h3>Nueva Relacion Pais-Gobierno</h3>
    ...
    <div id="pnlEdit" runat="server" visible="false" class="modal-overlay show">
        <div class="modal-dialog">
            <h3>Editar Relacion Pais-Gobierno</h3>
