<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PaisesIdiomas.aspx.vb" Inherits="PaisesIdiomas" MasterPageFile="~/Site.master" Title="Paises-Idiomas" %>
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <h2>PAISES_IDIOMAS</h2>
    <div class="toolbar">
    ...
    <div id="pnlAdd" runat="server" visible="false" class="modal-overlay show">
        <div class="modal-dialog">
            <h3>Nueva Relacion Pais-Idioma</h3>
    ...
    <div id="pnlEdit" runat="server" visible="false" class="modal-overlay show">
        <div class="modal-dialog">
            <h3>Editar Relacion Pais-Idioma</h3>
